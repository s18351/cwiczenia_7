...
public partial class S18351Context : DbContext
{
    public S18351Context()
    {
    }

    public S18351Context(DbContextOptions<S18351Context> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=db-mssql16.pjwstk.edu.pl;Initial Catalog=s18351;Integrated Security=True;TrustServerCertificate=True");
